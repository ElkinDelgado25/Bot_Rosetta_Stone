...
from Resolucion_script_rosseta.infraestructura.core import get_settings
from Resolucion_script_rosseta.infraestructura.state.state_store import StateStore
...
class RunManager:
    ...
    def _fluency_state(self, profile: Profile):
        ...
        if not path.exists():
            return None
        from Resolucion_script_rosseta.infraestructura.state.run_progress_state import (
            RunProgressState,
        )
