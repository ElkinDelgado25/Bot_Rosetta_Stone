...
Trampa medida el 02-09-2026: `FLUENCY_MAX_LESSONS=all` en el .env no hacía
...
env_loader = importlib.import_module(
    "rosseta_stone_script_a.infrastructure.core.env_loader"
)
...
def test_una_variable_solo_en_el_env_llega_a_os_getenv(tmp_path, monkeypatch):
    _escribir_env(tmp_path, "FLUENCY_MAX_LESSONS=all\n")
